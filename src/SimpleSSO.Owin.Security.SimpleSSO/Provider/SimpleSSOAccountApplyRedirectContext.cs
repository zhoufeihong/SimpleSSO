...
namespace Microsoft.Owin.Security.SimpleSSO
{
    ...
    /// </summary>
    public class SimpleSSOAccountApplyRedirectContext : BaseContext<SimpleSSOAccountAuthenticationOptions>
    {
        /// <summary>
        ...
        public SimpleSSOAccountApplyRedirectContext(IOwinContext context, SimpleSSOAccountAuthenticationOptions options,
