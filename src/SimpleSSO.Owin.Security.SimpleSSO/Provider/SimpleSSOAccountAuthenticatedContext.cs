...
namespace Microsoft.Owin.Security.SimpleSSO
{
    ...
    /// </summary>
    public class SimpleSSOAccountAuthenticatedContext : BaseContext
    {
        /// <summary>
        /// Initializes a <see cref="SimpleSSOAccountAuthenticatedContext"/>
        /// </summary>
        ...
        public SimpleSSOAccountAuthenticatedContext(IOwinContext context, JObject user, string accessToken, 
