...
{
    /// <summary>
    /// Configuration options for <see cref="SimpleSSOAccountAuthenticationMiddleware"/>
    /// </summary>
    public class SimpleSSOAccountAuthenticationOptions : AuthenticationOptions
    {
        /// <summary>
        /// Initializes a new <see cref="SimpleSSOAccountAuthenticationOptions"/>.
        /// </summary>
        ...
        public SimpleSSOAccountAuthenticationOptions() : base(Constants.DefaultAuthenticationType)
        {
            Caption = Constants.DefaultAuthenticationType;
            CallbackPath = new PathString("/signin-simplesso");
        ...
        /// </summary>
        /// <remarks>
        /// The default value is 'SimpleSSOAuthentication'
        /// </remarks>
        ...
        /// <summary>
        /// Gets or sets the <see cref="ISimpleSSOAccountAuthenticationProvider"/> used to handle authentication events.
        /// </summary>
        public ISimpleSSOAccountAuthenticationProvider Provider { get; set; }
